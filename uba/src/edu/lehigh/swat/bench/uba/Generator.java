...
public class Generator {
  ...
  /** ConferencePaper */
  static final int CS_C_CONFPAPER = CS_C_PUBLICATION + 1;	//Added id for conference paper
  /** JournalArticle */
  static final int CS_C_JOURNALARTICLE = CS_C_CONFPAPER + 1;	//Added id for journal article  
  /** Chair */
  static final int CS_C_CHAIR = CS_C_JOURNALARTICLE + 1;
  /** Research */
  ...
  static final int[][] CLASS_INFO = {
      ...
      {0, CS_C_NULL}, //CS_C_CONFPAPER
      {0, CS_C_NULL}, //CS_C_JOURNALARTICLE
  ...
  static final String[] CLASS_TOKEN = {
      ...
      "ConferencePaper", //CS_C_CONFPAPER	//Added
      "JournalArticle", //CS_C_JOURNALARTICLE	//Added
      "Chair", //CS_C_CHAIR
  ...
  /** year */
  static final int CS_P_YEAR = CS_P_WORKSFOR + 1;	//Added
  /** conferenceName */
  static final int CS_P_CONFNAME = CS_P_YEAR + 1;	//Added
  /** impactFactor */
  static final int CS_P_IF = CS_P_CONFNAME + 1;	//Added
  /** journalName */
  static final int CS_P_JOURNALNAME = CS_P_IF + 1;	//Added
  ...
  static final String[] PROP_TOKEN = {
      ...
      "subOrganizationOf",
      "worksFor",
      "year rdf:datatype=\"http://www.w3.org/2001/XMLSchema#int\"",	//Added
      "conferenceName",
      "impactFactor rdf:datatype=\"http://www.w3.org/2001/XMLSchema#double\"",
      "journalName"
  };
  ...
  /** ADDED */
  /** minimum number of conference papers of a full professor */
  private static final int FULLPROF_CONF_MIN = 11;
  /** maximum number of conference papers of a full professor */
  private static final int FULLPROF_CONF_MAX = 15;
  /** minimum number of journal articles of a full professor */
  private static final int FULLPROF_JOURN_MIN = 4;
  /** maximum number of journal articles of a full professor */
  private static final int FULLPROF_JOURN_MAX = 5;  
  /** minimum number of conference papers of an associate professor */
  private static final int ASSOPROF_CONF_MIN = 8;
  /** maximum number of conference papers of an associate professor */
  private static final int ASSOPROF_CONF_MAX = 14;
  /** minimum number of journal articles of an associate professor */
  private static final int ASSOPROF_JOURN_MIN = 3;
  /** maximum number of journal articles of an associate professor */
  private static final int ASSOPROF_JOURN_MAX = 5;
  /** minimum number of conference papers of an assistant professor */
  private static final int ASSTPROF_CONF_MIN = 4;
  /** maximum number of conference papers of an assistant professor */
  private static final int ASSTPROF_CONF_MAX = 8;
  /** minimum number of journal articles of an assistant professor */
  private static final int ASSTPROF_JOURN_MIN = 1;
  /** maximum number of journal articles of an assistant professor */
  private static final int ASSTPROF_JOURN_MAX = 3;
  /** minimum number of conference papers of a lecturer */
  private static final int LEC_CONF_MIN = 0;
  /** maximum number of conference papers of a lecturer */
  private static final int LEC_CONF_MAX = 4;
  /** minimum number of journal articles of a lecturer */
  private static final int LEC_JOURN_MIN = 0;
  /** maximum number of journal articles of a lecturer */
  private static final int LEC_JOURN_MAX = 1;
  
  /** configuration of publications */
  /** maximum impact factor for journal publications */
  private static final int IF_MAX = 5;
  /** minimum year of publication */
  private static final int PUB_MIN_YEAR = 2008;
  /** maximum year of publication */
  private static final int PUB_MAX_YEAR = 2012;
  /** size of the pool of conferences */
  private static final int CONF_NUM = 30;
  /** size of the pool of journals */
  private static final int JOURNAL_NUM = 30;
  ...
  private class PublicationInfo {
    ...
    public String name;
    /** year */
    public int year;	//Added    
    /** list of authors */
    public ArrayList authors;
  }
  
  /** informaiton of a conference paper instance */	
  private class ConferencePaperInfo extends PublicationInfo {	//Added
    /** conferenceId */
    public String conferenceName;
  }
  
  /** informaiton of a journal article instance */	
  private class JournalArticleInfo extends PublicationInfo {	//Added
    /** conferenceId */
  ...
  /**
   * Assigns conference papers to the specified faculty.
   * @param author Id of the faculty
   * @param min Minimum number of conference papers
   * @param max Maximum number of conference papers
   */
  private void _assignFacultyConferencePapers(String author, int min, int max) {	//Added
    int num;
  ...
  /**
   * Assigns journal articles to the specified faculty.
   * @param author Id of the faculty
   * @param min Minimum number of journal articles
   * @param max Maximum number of journal articles
   */
  private void _assignFacultyJournalArticles(String author, int min, int max) {		//Added
    int num;
  ...
  /**
   * Generates a conference paper instance.
   * @param conferencePaper Information of the publication.
   */
  private void _generateAConferencePaper(ConferencePaperInfo conferencePaper) {		//Added
  ...
  /**
   * Generates a journal article instance.
   * @param journalArticle Information of the publication.
   */
  private void _generateAJournalArticle(JournalArticleInfo journalArticle) {	//Added
  ...
  /**
   * Randomly select a double from a range 0 - MAX
   * @param max Maximum value of the selectable double.
   * @return The selected double.
   */
  private double _getRandomFromRange(int max) {
